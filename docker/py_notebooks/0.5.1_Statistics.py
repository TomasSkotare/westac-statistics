...
P.IntervalDict({P.closed(row.start_dt,row.end_dt):row.party for idx, row in dataframe.iterrows()})

# output = P.IntervalDict()
# idx, row in dataframe.iterrows():
#     i = P.closed(row.start_dt,row.end_dt)
